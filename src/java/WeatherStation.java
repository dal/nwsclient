...
public class WeatherStation extends Object
{
	...
	public WeatherStation nearestNeighbor(double lat, double lon)
	{
	...
	public static InputStream getList() throws IOException
	{
	...
	public static WeatherStation findNearest(double lat, double lon)
	{
		WeatherStation closest = new WeatherStation();
		...
		try {
			...
			closest = _root.nearestNeighbor(lat, lon);
